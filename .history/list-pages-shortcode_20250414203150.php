	...
	class List_Pages_Shortcode_Walker_Page extends Walker_Page {
		...
		public function start_el( &$output, $page, $depth = 0, $args = array(), $current_page = 0 ) {
			...
			if ( isset( $args['pages_with_children'][ $page->ID ] ) ) {
				...
				$item = '<a href="' . get_permalink( $page->ID ) . '">' . 
						$args['link_before'] . 
						apply_filters( 'the_title', $page->post_title, $page->ID ) . 
						$args['link_after'] . 
						'</a>';
			...
			$item = '<a href="' . get_permalink( $page->ID ) . '" role="menuitem" tabindex="-1">' . $args['link_before'] . apply_filters( 'the_title', $page->post_title, $page->ID ) . $args['link_after'] . '</a>';
